...
mod tests {
    ...
    fn test_map_operator() {
        ...
        let sum_expr = Expr::binary(Expr::column("a"), Operator::Add, Expr::column("b"));
    ...
    fn test_projection_operator() {
        ...
        let exprs = vec![("a".to_string(), &a_expr), ("sum".to_string(), &sum_expr)];
